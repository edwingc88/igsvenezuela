import { k as createInvalidVariablesError, n as getEnv$1, x as setOnSetGetEnv } from './entrypoint_DdLTSici.mjs';
...
const schema = {"CLOUDINARY_CLOUD_NAME":{"context":"server","access":"secret","type":"string"},"CLOUDINARY_API_KEY":{"context":"server","access":"secret","type":"string"},"CLOUDINARY_API_SECRET":{"context":"server","access":"secret","type":"string"},"SUPABASE_URL":{"context":"server","access":"secret","type":"string"},"SUPABASE_SERVICE_ROLE_KEY":{"context":"server","access":"secret","type":"string"}};
...
setOnSetGetEnv(() => {
	CLOUDINARY_CLOUD_NAME = _internalGetSecret("CLOUDINARY_CLOUD_NAME");
CLOUDINARY_API_KEY = _internalGetSecret("CLOUDINARY_API_KEY");
CLOUDINARY_API_SECRET = _internalGetSecret("CLOUDINARY_API_SECRET");
SUPABASE_URL = _internalGetSecret("SUPABASE_URL");
SUPABASE_SERVICE_ROLE_KEY = _internalGetSecret("SUPABASE_SERVICE_ROLE_KEY");

});
let CLOUDINARY_CLOUD_NAME = _internalGetSecret("CLOUDINARY_CLOUD_NAME");
let CLOUDINARY_API_KEY = _internalGetSecret("CLOUDINARY_API_KEY");
let CLOUDINARY_API_SECRET = _internalGetSecret("CLOUDINARY_API_SECRET");
let SUPABASE_URL = _internalGetSecret("SUPABASE_URL");
let SUPABASE_SERVICE_ROLE_KEY = _internalGetSecret("SUPABASE_SERVICE_ROLE_KEY");

export { CLOUDINARY_API_KEY as C, SUPABASE_SERVICE_ROLE_KEY as S, CLOUDINARY_API_SECRET as a, CLOUDINARY_CLOUD_NAME as b, SUPABASE_URL as c };
